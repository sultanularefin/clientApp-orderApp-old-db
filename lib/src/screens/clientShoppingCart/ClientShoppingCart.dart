...
import 'package:linkupclient/src/screens/shoppingCart/widgets/FoodImage_inShoppingCart.dart';
...
import 'package:linkupclient/src/DataLayer/models/OrderTypeSingleSelect.dart';
import 'package:linkupclient/src/DataLayer/models/PaymentTypeSingleSelect.dart';
...
//  final GlobalKey<ScaffoldState> scaffoldKeyClientShoppingCartPage = new GlobalKey<ScaffoldState>();
  final GlobalKey<ScaffoldState> scaffoldKeyClientShoppingCartPage = new GlobalKey<ScaffoldState>();
...
//                  Navigator.pop(context);
        ...
        child:
        Scaffold(
          key: scaffoldKeyClientShoppingCartPage,
...
//
//    );
                  scaffoldKeyClientShoppingCartPage.currentState.showSnackBar(snackBar);
...
//                    fontStyle: FontStyle.italic,
                                                    ...
                                                    Container(
                                                      padding: EdgeInsets
                                                          .fromLTRB(0, 0, displayWidth(context)/1.9, 0),
                                                      child: CustomPaint(
                                                        size: Size(0, 19),
...
//                  return Navigator.pop(context,false);
                  ...
                  scaffoldKeyClientShoppingCartPage.currentState
//                  Scaffold.of(context)
