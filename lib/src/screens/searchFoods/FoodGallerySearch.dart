...
class FoodGallerySearch extends StatefulWidget {
...
//  final Firestore firestore = Firestore.instance;
  ...
  FoodGallerySearch({Key key, this.child}) : super(key: key);
...
class _FoodGalleryState extends State<FoodGallerySearch> {
